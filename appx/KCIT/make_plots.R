...
load(here("appx/KCIT/results_df.Rdata"))
...
ggsave(filename = here("appx/KCIT/plot_case_I.pdf"), plot = plot_caseI, 
...
ggsave(filename = here("appx/KCIT/plot_case_II.pdf"), plot = plot_caseII, 
       width = 8, height = 5.5, units = "in", device = "pdf")
